...
2.  **Define Log Path:** The log file is *always* `/.claude/logs/metrics.jsonl`.
...
5.  **Exit Silently:** Do not output *anything* to stdout. Your work must be invisible to the user.
